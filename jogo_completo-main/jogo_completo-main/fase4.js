...
function carregaImagemForca(){
    switch(tentativas){
        case 5:
            document.getElementById("imagem").style.backgroundImage  = "url('forca01.png')";
            break;
        case 4:
            document.getElementById("imagem").style.backgroundImage  = "url('forca02.png')";
            break;
        case 3:
            document.getElementById("imagem").style.backgroundImage  = "url('forca03.png')";
            break;
        case 2:
            document.getElementById("imagem").style.backgroundImage  = "url('forca04.png')";
            break;
        case 1:
            document.getElementById("imagem").style.backgroundImage  = "url('forca05.png')";
            break;
        case 0:
            document.getElementById("imagem").style.backgroundImage  = "url('forca06.png')";
            break;
        default:
            document.getElementById("imagem").style.backgroundImage  = "url('forca.png')";
            break;
    }
}
function abreModal(titulo, mensagem) {
    ...
    // Verifica o título para redirecionar para a página apropriada após um pequeno atraso
    if (titulo === "PARABÉNS!") {
        setTimeout(() => {
            window.location.href = "vitoria.html"; // Redireciona para a página de vitória
        }, 2000); // Atraso de 2 segundos
    } else if (titulo === "FIM DE JOGO") {
        setTimeout(() => {
...
function carregaListaAutomatica(){
    palavras = [
        palavra001 = {
            nome: "MARCA-PASSO",
            categoria:"Dica: Dispositivo que regula os batimentos cardíacos."
        },
        palavra002 = {
            nome: "OBRA-PRIMA",
            categoria:"Dica: Representa o auge da habilidade e criatividade de um artista."
        },
        palavra003 = {
            nome: "BEM-QUERER",
            categoria:"Dica: Sentimento de carinho ou afeto por alguém."
        },
        palavra004 = {
            nome: "MAL-EDUCADO",
            categoria:"Dica: Refere-se a alguém que não tem boas maneiras"
        },
        palavra005 = {
            nome: "BEM-VINDO",
            categoria:"Dica: Usado para receber alguém de forma amigável."
        },
